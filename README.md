...
| ----------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------- |
| **[openmetadata-docker-demo](https://github.com/monika393/openmetadata-docker-demo)**     | Local OpenMetadata stack with ingestion, profiling, and quality tests | Docker, YAML, MySQL |
| **[federated_learning_flower](https://github.com/monika393/federated_learning_flower)**   | Minimal federated learning demos                                      | Flower, Python      |
| **[visual-anomaly-detection](https://github.com/monika393/visual-anamoly-detection)**     | Image anomaly detection with overlays/heatmaps                        | Jupyter, PyTorch    |
| **[pyod-anomaly-detection](https://github.com/monika393/pyod-anamoly-detection)**         | PyOD baselines across tabular/text/graph/time series                  | PyOD, scikit-learn  |
| **[automl-benchmark](https://github.com/monika393/automl-benchmark)**                     | Compact AutoML baselines with repeatable splits                       | Jupyter, sklearn    |
| **[timeseries-analysis](https://github.com/monika393/timeseries-analysis)**               | Rolling stats, features, detectors                                    | Pandas, statsmodels |
| **[ML-Flow](https://github.com/monika393/ML-Flow)**                                       | Experiment tracking patterns & reproducible runs                      | MLflow, Python      |
| **[llm-metadata-generator](https://github.com/monika393/llm-metadata-generator)**         | Scripts to curate metadata for LLM tasks                              | Python              |
| **[llm-lazy-recipe-generator](https://github.com/monika393/llm-lazy-recipe-gnerator)**    | Small LLM utility; MIT-licensed                                       | Python              |
...
GitHub: **[github.com/monika393](https://github.com/monika393)**
